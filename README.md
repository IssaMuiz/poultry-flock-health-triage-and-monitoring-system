...
* Consistent RGB color channels
* Similar backgrounds across images

---

### Dataset Limitations

* Image resolution is relatively low (100 × 100 pixels).
* Droppings occupy only a small region of the image.
* Low contrast between droppings and the surrounding litter.
* Dataset contains image data only; no complementary metadata (e.g., flock age, mortality, feed intake, or clinical signs).
